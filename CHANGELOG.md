...
* 实时从浏览页面中移除已删除的备忘录和子目录 ([30e93bb](https://github.com/NateScarlet/image-funnel/commit/30e93bbaac338cd73b4b65ddee1682e2b0907efb))
...
* 统一并在图片查看器中内置图片备注编辑功能 ([080909c](https://github.com/NateScarlet/image-funnel/commit/080909c4009a3f270f7704a40333246fea3b66cf))
...
* 图片二进制数据被错误载入为备忘录文本 ([e65def3](https://github.com/NateScarlet/image-funnel/commit/e65def3056e7af0b878be04a80badc5739b79603))
